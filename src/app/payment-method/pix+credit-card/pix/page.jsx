    ...
    <main className="bg-gradient-to-br from-purple-500 to-blue-800 min-h-screen flex flex-col">
      <Container className=" jusfify-center rounded-lg drop-shadow-sm bg-white flex flex-col my-auto w-screen min-h-screen max-w-lg ">
        ...
        <section
          name='qrcode-area'
          id="qr-area"
          className="w-10/12 h-10/12 flex items-center justify-center self-center p-2 border-green-300 border-2 rounded-lg "
        >
          <Image
            height={"550"}
            width={"550"}
        ...
        >
          <Button className="normal-case rounded-xl flex justify-between bg-blue-950 text-lg font-medium py-2 px-4" variant="contained">Clique para copiar QR CODE <FileCopyIcon className='text-base ml-2 align-center' /> </Button>
        </section>
        <PaymentDate/>
