...
export default function InstallmentArea({ totalPrice, isPromo, totalNoInstallment, cashbackPercent, isTop, isBottom, topTitle, numberOfInstallments }) {
  return (
    <div className="relative" name="installments">
        ...
        ></input>
        <label htmlFor={numberOfInstallments} className=" pt-1 rounded-lg text-red flex flex-col  peer-checked:border-green-400 py-4 pt-3 border-2 border-gray-200 mb-0 "
          >
        ...
        {
            isPromo == true ?         <div className="p-3 rounded-full absolute top-10 right-4 my-auto w-6 h-6 peer-checked:bg-green-400 peer-checked:border-green-400 border-2 "></div>
            :
